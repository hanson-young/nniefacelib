...
if __name__ == '__main__':
    ...
    root_dir = "/home/unaguo/hanson/data/landmark/WFLW191104"
    imageDirs = os.path.join(root_dir, 'WFLW_images')
    Mirror_file = os.path.join(root_dir, 'WFLW_annotations/Mirror98.txt')

    # landmarkDirs = ['WFLW_annotations/list_98pt_rect_attr_train_test/list_98pt_rect_attr_test.txt',
    #                 'WFLW_annotations/list_98pt_rect_attr_train_test/list_98pt_rect_attr_train.txt']
    #
    # outDirs = ['test_data', 'train_data']
    # landmarkDirs = ['WFLW_annotations/list_98pt_rect_attr_train_test/list_98pt_rect_attr_train.txt']
    # outDirs = ['train_data']
    landmarkDirs = ['WFLW_annotations/list_98pt_rect_attr_train_test/list_98pt_rect_attr_test.txt']
    outDirs = ['test_data']
