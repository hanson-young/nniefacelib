...
class AddModelInputsOutputs(object):
    '''
    Expose hidden states of recurrent layers as models inputs and outputs
    '''
    def __call__(self, graph):  # type: (Graph) -> Graph
...
class ImageScalerRemover(object):
    '''
    Removes ImageScaler layer if connected to a models input and single parent child nodes
    '''
